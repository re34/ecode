...
#define USART2_GPIO_CLK_ENABLE()    LL_IOP_GRP1_EnableClock(LL_IOP_GRP1_PERIPH_GPIOA)
#define USART2_TX_PIN               LL_GPIO_PIN_2
#define USART2_TX_GPIO_PORT              GPIOA
#define USART2_SET_TX_GPIO_AF()         LL_GPIO_SetAFPin_0_7(USART2_TX_GPIO_PORT, LL_GPIO_PIN_2, LL_GPIO_AF_4)
#define USART2_RX_PIN               LL_GPIO_PIN_3
#define USART2_RX_GPIO_PORT              GPIOA
#define USART2_SET_RX_GPIO_AF()         LL_GPIO_SetAFPin_0_7(USART2_RX_GPIO_PORT,LL_GPIO_PIN_3, LL_GPIO_AF_4)
