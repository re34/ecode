...
#define UART_SET_TX_GPIO_AF()         LL_GPIO_SetAFPin_0_7(UART_TX_GPIO_PORT, LL_GPIO_PIN_2, LL_GPIO_AF_4)
#define UART_RX_PIN               LL_GPIO_PIN_3
#define UART_RX_GPIO_PORT              GPIOA
#define UART_SET_RX_GPIO_AF()         LL_GPIO_SetAFPin_0_7(UART_RX_GPIO_PORT,LL_GPIO_PIN_3, LL_GPIO_AF_4)
