...
#define UART1_CLK_ENABLE()     LL_APB2_GRP1_EnableClock(LL_APB2_GRP1_PERIPH_USART1)
#define UART1_CLK_SOURCE()     LL_RCC_SetUSARTClockSource(LL_RCC_USART1_CLKSOURCE_PCLK2)
#define UART1_GPIO_CLK_ENABLE()    LL_AHB1_GRP1_EnableClock(LL_AHB1_GRP1_PERIPH_GPIOA)
#define UART1_TX_PIN               LL_GPIO_PIN_9
#define UART1_TX_GPIO_PORT              GPIOA
#define UART1_SET_TX_GPIO_AF()         LL_GPIO_SetAFPin_8_15(UART1_TX_GPIO_PORT, UART1_TX_PIN, LL_GPIO_AF_7)
#define UART1_RX_PIN               LL_GPIO_PIN_10
#define UART1_RX_GPIO_PORT              GPIOA
#define UART1_SET_RX_GPIO_AF()         LL_GPIO_SetAFPin_8_15(UART1_RX_GPIO_PORT,UART1_RX_PIN, LL_GPIO_AF_7)
...
#define UART2_SET_TX_GPIO_AF()         LL_GPIO_SetAFPin_0_7(UART2_TX_GPIO_PORT, LL_GPIO_PIN_2, LL_GPIO_AF_7)
#define UART2_RX_PIN               LL_GPIO_PIN_3
#define UART2_RX_GPIO_PORT              GPIOA
#define UART2_SET_RX_GPIO_AF()         LL_GPIO_SetAFPin_0_7(UART2_RX_GPIO_PORT,LL_GPIO_PIN_3, LL_GPIO_AF_7)
...
static e_err_t stm_uart_init(struct serial_dev *serial)
{
    ...
    if(uart->instance==UART2_INSTANCE)
        LL_USART_SetBaudRate(uart->instance, SystemCoreClock/2, LL_USART_OVERSAMPLING_16, cfg->baud_rate); 
#endif
