...
static const struct command_item bt_commands[]={
    {.name="bt_mode", .handle = bt_mode, "(mode),mode=cli|com, set bt spp mode\r\n"},
    {.name="bt_write", .handle = bt_write, "(msg),msg type is string, write data to bt spp\r\n"},
    {NULL,NULL,NULL},
};
...
{
    command_register_commands(&bt_commands_entry, (struct command_item *)bt_commands);
}
